...
# amal_first_kedro documentation build
...
from amal_first_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "amal_first_kedro"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "amal_first_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "amal_first_kedro.tex",
        "amal_first_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "amal_first_kedro",
        "Project amal_first_kedro codebase.",
        "Data-Science",
    )
]
